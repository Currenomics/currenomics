...
def extract(**kwargs):
    ...
    korea_trade_balance = fred.get_series(SERIES_ID, observation_start="2000-01-01")

    trade_balance_df = pd.DataFrame({"date": korea_trade_balance.index, "trade_balace": korea_trade_balance.values})
    # S3로 CSV저장
